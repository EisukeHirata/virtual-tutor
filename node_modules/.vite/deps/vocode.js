...
var init_add_unique_number = __esm({
  "node_modules/fast-unique-numbers/build/es2019/factories/add-unique-number.js"() {
    createAddUniqueNumber = (generateUniqueNumber2) => {
      return (set) => {
...
var init_generate_unique_number = __esm({
  "node_modules/fast-unique-numbers/build/es2019/factories/generate-unique-number.js"() {
    ...
    createGenerateUniqueNumber = (cache2, lastNumberWeakMap) => {
      return (collection) => {
...
var init_is_supported_promise = __esm({
  "node_modules/extendable-media-recorder/build/es2019/factories/is-supported-promise.js"() {
    createIsSupportedPromise = (window5) => {
      if (window5 !== null && window5.BlobEvent !== void 0 && window5.MediaStream !== void 0 && (window5.MediaRecorder === void 0 || window5.MediaRecorder.isTypeSupported !== void 0)) {
        return new Promise((resolve) => {
          if (window5.MediaRecorder === void 0) {
            return resolve(true);
          }
          const canvasElement = window5.document.createElement("canvas");
...
var init_post_message_factory = __esm({
  "node_modules/recorder-audio-worklet/build/es2019/factories/post-message-factory.js"() {
    createPostMessageFactory = (generateUniqueNumber2) => {
...
var init_module8 = __esm({
  "node_modules/recorder-audio-worklet/build/es2019/module.js"() {
    ...
    createRecorderAudioWorkletNode = createRecorderAudioWorkletNodeFactory(createListener, createPostMessageFactory(generateUniqueNumber), on, validateState);
  }
});
      ...
      return (eventTarget, nativeMediaRecorderConstructor2, mediaStream, mimeType) => {
        ...
        nativeMediaRecorder.addEventListener("error", (event) => {
          ...
          eventTarget.dispatchEvent(new ErrorEvent("error", {
            error: event.error === void 0 ? createInvalidModificationError2() : event.error
          }));
        });
...
// node_modules/extendable-media-recorder/build/es2019/types/native-blob-event-constructor.js
var init_native_blob_event_constructor2 = __esm({
  "node_modules/extendable-media-recorder/build/es2019/types/native-blob-event-constructor.js"() {
  }
});

// node_modules/extendable-media-recorder/build/es2019/types/native-blob-event-constructor-factory.js
var init_native_blob_event_constructor_factory = __esm({
  "node_modules/extendable-media-recorder/build/es2019/types/native-blob-event-constructor-factory.js"() {
  }
});
...
// node_modules/extendable-media-recorder/build/es2019/types/native-media-recorder.js
var init_native_media_recorder2 = __esm({
  "node_modules/extendable-media-recorder/build/es2019/types/native-media-recorder.js"() {
  }
});

// node_modules/extendable-media-recorder/build/es2019/types/native-media-recorder-constructor.js
var init_native_media_recorder_constructor2 = __esm({
  "node_modules/extendable-media-recorder/build/es2019/types/native-media-recorder-constructor.js"() {
  }
});
...
var init_types11 = __esm({
  "node_modules/extendable-media-recorder/build/es2019/types/index.js"() {
    ...
    init_native_blob_event_constructor2();
    init_native_blob_event_constructor_factory();
    init_native_event_target2();
    init_native_media_recorder2();
    init_native_media_recorder_constructor2();
...
// node_modules/vocode/dist/utils.js
var require_utils = __commonJS({
  "node_modules/vocode/dist/utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.stringify = exports.blobToBase64 = void 0;
    var snake_case_1 = (init_dist4(), __toCommonJS(dist_exports));
    var blobToBase64 = (blob3) => {
      return new Promise((resolve, _) => {
        const reader = new FileReader();
        reader.onloadend = () => {
          var _a;
          return resolve(((_a = reader.result) === null || _a === void 0 ? void 0 : _a.toString().split(",")[1]) || null);
        };
  ...
  "node_modules/ua-parser-js/dist/ua-parser.min.js"(exports, module) {
    (function(window5, undefined2) {
      ...
      var UAParser = function(ua, extensions) {
        ...
        var _navigator = typeof window5 !== UNDEF_TYPE && window5.navigator ? window5.navigator : undefined2;
      ...
      if (typeof exports !== UNDEF_TYPE) {
        ...
        } else if (typeof window5 !== UNDEF_TYPE) {
          window5.UAParser = UAParser;
        }
      }
      var $ = typeof window5 !== UNDEF_TYPE && (window5.jQuery || window5.Zepto);
      if ($ && !$.ua) {
...
// node_modules/vocode/dist/hooks/conversation.js
var require_conversation = __commonJS({
  "node_modules/vocode/dist/hooks/conversation.js"(exports) {
    "use strict";
    ...
    var extendable_media_recorder_1 = (init_module12(), __toCommonJS(module_exports));
    var extendable_media_recorder_wav_encoder_1 = (init_module14(), __toCommonJS(module_exports2));
    var react_1 = __importDefault(require_react());
    var utils_1 = require_utils();
    var react_device_detect_1 = require_lib();
    var buffer_1 = require_buffer();
    var VOCODE_API_URL = "api.vocode.dev";
    var useConversation = (config) => {
      ...
      react_1.default.useEffect(() => {
        ...
        const audioAnalyser2 = audioContext2.createAnalyser();
        setAudioAnalyser(audioAnalyser2);
      }, []);
      react_1.default.useEffect(() => {
        if (!recorder || !socket)
          return;
        if (status === "connected") {
          recorder.addEventListener("dataavailable", ({ data }) => {
            (0, utils_1.blobToBase64)(data).then((base64Encoded) => {
              ...
              socket.readyState === WebSocket.OPEN && socket.send((0, utils_1.stringify)(audioMessage));
            });
          });
        }
      ...
      const stopConversation = (error2) => {
        ...
        ![WebSocket.CLOSING, WebSocket.CLOSED].includes(socket.readyState) && socket.close();
      };
      const startConversation = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        setError(void 0);
        const socket2 = new WebSocket(`wss://${baseUrl}/conversation?key=${token}`);
        let error2;
        socket2.onerror = (event) => {
          console.error(event);
          error2 = new Error("See console for error details");
        };
        ...
        try {
          ...
          if (error3 instanceof DOMException && error3.name === "NotAllowedError") {
            alert("Allowlist this site at chrome://settings/content/microphone to talk to the bot.");
            error3 = new Error("Microphone access denied");
          }
          console.error(error3);
          stopConversation(error3);
          return;
        }
        ...
        socket2.send((0, utils_1.stringify)(startMessage));
        ...
        recorderToUse.start(Math.round(1e3 * transcriberConfig.chunkSize / transcriberConfig.samplingRate));
      });
      return {
        status,
...
// node_modules/vocode/dist/types/conversation.js
var require_conversation2 = __commonJS({
  "node_modules/vocode/dist/types/conversation.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/vocode/dist/types/vocode/agent.js
var require_agent = __commonJS({
  "node_modules/vocode/dist/types/vocode/agent.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/vocode/dist/types/vocode/audioEncoding.js
var require_audioEncoding = __commonJS({
  "node_modules/vocode/dist/types/vocode/audioEncoding.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/vocode/dist/types/vocode/transcriber.js
var require_transcriber = __commonJS({
  "node_modules/vocode/dist/types/vocode/transcriber.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/vocode/dist/types/vocode/synthesizer.js
var require_synthesizer = __commonJS({
  "node_modules/vocode/dist/types/vocode/synthesizer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/vocode/dist/types/vocode/websocket.js
var require_websocket = __commonJS({
  "node_modules/vocode/dist/types/vocode/websocket.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/vocode/dist/types/index.js
var require_types = __commonJS({
  "node_modules/vocode/dist/types/index.js"(exports) {
    "use strict";
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    __exportStar(require_conversation2(), exports);
    __exportStar(require_agent(), exports);
    __exportStar(require_audioEncoding(), exports);
    __exportStar(require_transcriber(), exports);
    __exportStar(require_synthesizer(), exports);
    __exportStar(require_websocket(), exports);
  }
});

// node_modules/vocode/dist/index.js
var require_dist = __commonJS({
  "node_modules/vocode/dist/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    Object.defineProperty(exports, "useConversation", { enumerable: true, get: function() {
      return conversation_1.useConversation;
    } });
...
// dep:vocode
var vocode_default = require_dist();
export {
  vocode_default as default
};
/*!
...
//# sourceMappingURL=vocode.js.map
