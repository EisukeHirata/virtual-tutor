import "./App.css";
import {
  AssemblyAITranscriberConfig, // Updated from DeepgramTranscriberConfig
  ...
  AudioDeviceConfig,
  ConversationConfig, // Added import for ConversationConfig
} from "vocode";
...
const agentConfig: ChatGPTAgentConfig = {
  ...
  initialMessage: {
    type: "message_base",
    text: "Welcome to your English Class. Are you ready?",
  },
  promptPreamble:
    "You are an English teacher.Teach English conversation gently. Ask questions about me.  ",
...
export default function App() {
  ...
  const localAgentConfig = shouldUseAzure
    ? { ...agentConfig, sendFillerAudio: false }
    : agentConfig;
  const localSynthesizerConfig = shouldUseAzure
    ? azureSynthesizerConfig
    : { ...basePlayHtConfig, voiceId: voiceIdConfig[interviewer] };

  return (
    <Flex direction="column" width="100wh" height="100vh">
      <VStack flex={1} justify={"center"}>
        <Heading color={"#f46526"}>YC Interview Prep</Heading>
          ...
          >
            <VStack>
              ...
              <HStack>
                ...
                />
                <a
                  href="https://www.producthunt.com/posts/ycinterview-ai?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-ycinterview&#0045;ai"
                  target="_blank"
                >
                  <img
                    src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=387291&theme=light"
                    alt="YCInterview&#0046;ai - Conduct&#0032;a&#0032;mock&#0032;YC&#0032;interview&#0032;entirely&#0032;done&#0032;via&#0032;AI | Product Hunt"
              ...
              <Text fontSize={"s"}>
                ...
                apps. Voices provided via Play.ht and Microsoft Azure.
              </Text>
            </VStack>
          </Box>
        </VStack>
